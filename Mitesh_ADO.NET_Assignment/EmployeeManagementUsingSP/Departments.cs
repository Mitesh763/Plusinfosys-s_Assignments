    ...
    class Departments
    {
            ...
            while (true)
            {
                using (SqlConnection connection = new SqlConnection(connString))
                {
                    using (SqlCommand objCmd = connection.CreateCommand())
                    {
                        ...
                        objCmd.CommandText = "sp_tblDepartmentsInsert";
                ...
                while (true)
                {
                    using (SqlConnection connection = new SqlConnection(connString))
                    {
                        ...
                        if (existDepartmentId(departmentId))
                        {
                            using (SqlCommand objCmd = connection.CreateCommand())
                            {
                                objCmd.CommandText = "sp_tblEmployeeSelectHighSalary";
                                objCmd.CommandType = CommandType.StoredProcedure;
                                objCmd.Parameters.AddWithValue("@departmentId", departmentId);
                ...
                while (true)
                {
                    ...
                    using (SqlConnection connection = new SqlConnection(connString))
                    {
                        ...
                        if (existDepartmentId(departmentId))
                        {
                            using (SqlCommand objCmd = connection.CreateCommand())
                            {
                                objCmd.CommandText = "sp_tblEmployeeSelectSecondHighSalary";
                                objCmd.CommandType = CommandType.StoredProcedure;
                                objCmd.Parameters.AddWithValue("@departmentId", departmentId);
        ...
        public static bool getTotalDepartment()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connString))
            {
                using (SqlCommand objCmd = connection.CreateCommand())
                {
                    objCmd.CommandText = "sp_tblDepartmentExistList";
                    objCmd.CommandType = CommandType.StoredProcedure;
        ...
        public static bool existDepartmentId(int Id)
        {
            using (SqlConnection connection = new SqlConnection(connString))
            {
                using (SqlCommand objCmd = connection.CreateCommand())
                {
                    objCmd.CommandText = "sp_tblDepartmentExistID";
                    objCmd.CommandType = CommandType.StoredProcedure;
