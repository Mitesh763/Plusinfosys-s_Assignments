    ...
    class Employees
    {
        ...
        public static void AddEmployee(Dictionary<string, string> employeeData)
        {
            ...
            if (Departments.getTotalDepartment())
            {
                ...
                objCmd.CommandText = "INSERT INTO tblEmployees ([Name], [Address], Designation, Gender, Salary, Department) VALUES (@name, @address, @designation, @gender, @salary, @department)";
            ...
            if (getTotalEmployee())
            {
                ...
                while (true)
                {
                    ...
                    if (existEmployeeId(employeeID))
                    {
                        ...
                        objCmd.CommandType = CommandType.Text;
                        objCmd.CommandText = "SELECT * FROM tblEmployees e JOIN tblDepartments d ON d.DepartmentId = e.Department WHERE EmployeeId = @employeeId";
        ...
        public static void GetEmployee()
        {
            if (getTotalEmployee())
            {
                ...
                objCmd.CommandType = CommandType.Text;
                objCmd.CommandText = "SELECT * FROM tblEmployees e JOIN tblDepartments d ON d.DepartmentId = e.Department  ORDER BY EmployeeId";
                objConn.Open();
                SqlDataReader reader = objCmd.ExecuteReader();
            ...
            if (getTotalEmployee())
            {
                ...
                while (true)
                {
                    ...
                    if (existEmployeeId(EmployeeID))
                    {
                        ...
                        objCmd.CommandType = CommandType.Text;
                        objCmd.CommandText = "UPDATE tblEmployees SET [Name] = @newName, [Address] = @newAddress, Designation = @newDesignation, Gender = @newGender, Salary = @newSalary, Department = @newDepartment WHERE EmployeeId = @employeeId";
            ...
            if (getTotalEmployee())
            {
                ...
                while (true)
                {
                    ...
                    if (existEmployeeId(EmployeeID))
                    {
                        ...
                        objCmd.CommandType = CommandType.Text;
                        objCmd.CommandText = "DELETE FROM tblEmployees WHERE EmployeeId = @employeeId";
        ...
        public static void ExistEmployee()
        {
            using (SqlConnection connection = new SqlConnection(connString))
            {
                ...
                {
                    objCmd.CommandText = "SELECT EmployeeId,Name FROM tblEmployees ORDER BY EmployeeId";
                    objCmd.CommandType = CommandType.Text;
        ...
        public static bool existEmployeeId(int Id)
        {
            using (SqlConnection connection = new SqlConnection(connString))
            {
                using (SqlCommand objCmd = connection.CreateCommand())
                {
                    objCmd.CommandText = "SELECT EmployeeId FROM tblEmployees WHERE EmployeeId = @id";
                    objCmd.CommandType = CommandType.Text;
        ...
        public static bool getTotalEmployee()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connString))
            {
                using (SqlCommand objCmd = connection.CreateCommand())
                {
                    objCmd.CommandText = "SELECT EmployeeId FROM tblEmployees";
                    objCmd.CommandType = CommandType.Text;
